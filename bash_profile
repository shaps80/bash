...
alias preview="qlmanage -p" # preview a doc with QuickLook

alias cd_development="cd /Users/Shaps/Library/Mobile\ Documents/com~apple~CloudDocs/Development/"
alias cd_personal="cd /Users/Shaps/Library/Mobile\ Documents/com~apple~CloudDocs/Development/personal"
alias cd_tab="cd /Users/Shaps/Library/Mobile\ Documents/com~apple~CloudDocs/Development/TAB"
...
function log() {
  tail -f /var/log/system.log | grep $1
}
...
set_prompt() {
  ...
  if [[ ! -z $SSH_CLIENT ]]; then
    ...
    PS1="\w $ssh_status[$local_branch$reset..$remote_branch$git_status] "
  fi
}
